...
@section('content')
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center text-center text-md-start" data-aos="fade-in"
                    ...
                    <p class="mt-2">Temukan dan panggil pedagang lokal di sekitar Anda dengan mudah melalui aplikasi
                        InstaApp, dukung usaha kecil, dan nikmati kemudahan berbelanja langsung dari genggaman Anda.</p>
        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
                    <p>
                        InstaApp adalah platform yang memungkinkan Anda untuk menemukan dan memanggil pedagang keliling di
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <p>Dengan InstaApp, kami tidak hanya menghubungkan Anda dengan pedagang lokal tetapi juga memberikan
    ...
    <section id="features" class="features section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Features</h2>
            <p>Berikut adalah fitu fitur yang ada pada InstaApp</p>
        </div><!-- End Section Title -->
        ...
        <div class="container">
            ...
            <div class="row gy-4 align-items-center features-item">
                ...
                <div class="col-md-7" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p>
                        Biaya admin di InstaApp itu hanya Rp 1000,- dan Metode Pembayaran yang digunakan aplikasi InstaApp
            ...
            <div class="row gy-4 align-items-center features-item">
                ...
                <div class="col-md-7 order-2 order-md-1" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="fst-italic">
                        Dengan *InstaApp*, berbelanja dari pedagang lokal menjadi lebih cepat, aman, dan praktis, langsung
            ...
            <div class="row gy-4 align-items-center features-item">
                ...
                <div class="col-md-7" data-aos="fade-up">
                    ...
                    <p>Dengan *InstaApp*, Anda dapat menemukan pedagang lokal yang ada di sekitar Anda secara real-time. Tak
    ...
    <section id="gallery" class="gallery section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Gallery</h2>
            <p>Berikut adalah tampilan dari aplikasi InstaApp</p>
        </div><!-- End Section Title -->
    ...
    <section id="testimonials" class="testimonials section light-background">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Testimonials</h2>
            <p>Dibawah ini adalah testimoni dari pelanggan setelah menggunakan aplikasi InstaApp</p>
        </div><!-- End Section Title -->
                        ...
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    ...
                                    <span>Aplikasi InstaApp benar-benar membantu saya dalam memenuhi kebutuhan sehari-hari.
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>InstaApp sangat memudahkan saya untuk menemukan pedagang keliling di sekitar
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>Sejak bergabung dengan aplikasi InstaApp, pelanggan saya semakin bertambah dan
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-wrap">
                            <div class="testimonial-item">
                                ...
                                <p>
                                    <i class="bi bi-quote quote-icon-left"></i>
                                    <span>InstaApp sangat membantu saya sebagai pedagang makanan keliling. Dengan aplikasi
                                        ...
                                        terlalu jauh. Terima kasih, InstaApp!</span>
                                    <i class="bi bi-quote quote-icon-right"></i>
                                </p>
                            </div>
